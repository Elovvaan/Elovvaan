...
export default function XpPrestigePage() {
  return (
    <div>
      <PageHero
        title="XP + Prestige"
        subtitle="Your activity earns XP. Your consistency earns prestige. Higher tiers unlock better rewards and limited prize promotions."
      />
      <div className="overflow-x-auto rounded-xl border border-slate-200">
        <table className="min-w-full text-left text-sm">
          ...
          <tbody>
            {[
              ['Bronze', '0 - 2,999', 'Starter rewards and beginner promotion access'],
              ['Silver', '3,000 - 9,999', 'Entry multipliers and weekly booster packs'],
              ['Gold', '10,000 - 24,999', 'Priority promotion entry and premium drops'],
              ['Prestige', '25,000+', 'Exclusive events, VIP support, and elite promotions']
